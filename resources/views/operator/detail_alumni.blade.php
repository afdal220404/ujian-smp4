    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
            <div class="flex items-center gap-2 text-gray-400 text-sm mb-1">
                <a href="{{ route('operator.alumni.index') }}" class="hover:text-primary transition-colors">Data Alumni</a>
        ...
        <a href="{{ route('operator.alumni.index') }}" class="px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-600 font-bold text-sm shadow-sm hover:bg-gray-50 transition-all flex items-center gap-2">
            <i class="bi bi-arrow-left"></i> Kembali ke Daftar Alumni
        </a>
    </div>

    {{-- Filter sudah dihapus --}}
    {{-- INFORMASI ALUMNI --}}
