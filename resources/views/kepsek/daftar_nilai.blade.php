...
@section('sidebar-menu')
    <a href="" class="menu-item active">Daftar Nilai</a>
    <a href="" class="menu-item">Daftar Siswa</a>
    <a href="" class="menu-item">Daftar Guru</a>
@endsection

@section('content')
 <div class="bg-white rounded-lg shadow-md p-6 w-full mb-5">
    <a class="judul">Daftar Nilai Siswa</a>
</div>
    <div class="overflow-x-auto">
              <table class="w-full border-collapse rounded-lg overflow-hidden shadow">
                    <thead>
                        <tr class="bg-gray-700 text-white text-center">
                            <th class="px-4 py-3 border border-gray-600">Nama Siswa</th>
                            <th class="px-4 py-3 border border-gray-600">Kelas</th>
                            <th class="px-4 py-3 border border-gray-600">Rata Rata Kuis</th>
                            <th class="px-4 py-3 border border-gray-600">Rata Rata UTS</th>
                            <th class="px-4 py-3 border border-gray-600">Rata Rata UAS</th>
                        </tr>
                    </thead>
